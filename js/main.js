(() => {
    ...
    // 选取第一个 h2.large 元素并写入文字
    var largeHeading = document.querySelector("body > div > div.hero > div > h2.large");
    if (largeHeading) {
        largeHeading.innerText = "落子無悔，永遠少年";
    }

    // 选取第二个 h2.sub 元素并写入文字
    var subHeading = document.querySelector("body > div > div.hero > div > h2.sub");
    if (subHeading) {
        subHeading.innerText = "若再许我少年时，一两黄金一两风";
    }
});
